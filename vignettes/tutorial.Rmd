...
# build a matrix to show the training error
training <- c((knn1[1] != my_penguins$species), length(knn2[1] != my_penguins$species), length(knn3[1] != my_penguins$species), length(knn4[1] != my_penguins$species), length(knn5[1] != my_penguins$species), length(knn6[1] != my_penguins$species), length(knn7[1] != my_penguins$species), length(knn8[1] != my_penguins$species), length(knn9[1] != my_penguins$species), length(knn10[1] != my_penguins$species))
training
```

Based on the CV misclassification rates, I would choose the model with k_nn = 1, because it has the lowest CV rates.
